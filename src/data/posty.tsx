...
export const posty: Posts[] = [
  ...
  },
  {
    ...
    img: post4,
    text1:
      "Przyszli właściciele mieszkań coraz częściej odwiedzają budowę, bo przecież to już czas na to, aby zacząć myśleć o urządzaniu kuchni salonu łazienki. Królują wanny wolnostojące i prysznic. Niedługo pierwsze wizualizacje, którymi się podzielimy. A w międzyczasie widać żelbet i silikaty. Dlaczego właśnie taki wybór?",
  ...
  },
  {
    ...
    img: post3,
    text1:
      "To już ten moment kiedy wchodząc na budowę już coś widać. Czas przed zalaniem stropu, ale już można zobaczyć pomieszczenia wśród ścian silikatowych. Co widać to duże miejsca pozostawione na przeszklenia w tym drzwi balkonowe na szerokość 2,5 m.",
  },
  {
    ...
    text3:
      "Wychodzimy z ziemi, a mieszkańcy budynku F i G już niedługo będą obserwować jak mury pną się do góry!",
  },
  {
    ...
    img: post1,
    text1:
      "Prosty, nowoczesny budynek, w którym znajdziesz doświetlone od strony południowej, czteropokojowe apartamenty, o metrażach 74,45 i 81,25 m2, każde z ogródkiem. ",
    text2:
      "Oszczędzaj z nami! Płaski dach idealny pod instalację fotowoltaiczną.",
    text3: "Zaaranżuj je sam, powiększ salon jeżeli tego potrzebujesz.",
    text4:
      "Rozpoczęcie budowy zaplanowano na marzec 2020 r. Relacje z tereny budowy znajdziesz w aktualnościach.",
  },
];
